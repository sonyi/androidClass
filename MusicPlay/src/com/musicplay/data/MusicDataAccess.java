...
public class MusicDataAccess {
	...
	public List<Music> getAllMusic() {
		...
		Cursor c = cr.query(Media.EXTERNAL_CONTENT_URI, projection, selection,
				selectionArgs, Media.DEFAULT_SORT_ORDER);

		List<Music> musicList = new ArrayList<Music>();
		while (c.moveToNext()) {
			Music music = new Music();
			music.setId(c.getLong(c.getColumnIndexOrThrow(Media._ID)));
			music.setTitle(c.getString(c.getColumnIndexOrThrow(Media.TITLE)));
			music.setTitleKey(c.getString(c
					.getColumnIndexOrThrow(Media.TITLE_KEY)));
			music.setDisplayName(c.getString(c
					.getColumnIndexOrThrow(Media.DISPLAY_NAME)));
			music.setTrack(c.getInt(c.getColumnIndexOrThrow(Media.TRACK)));
			music.setYear(c.getInt(c.getColumnIndexOrThrow(Media.YEAR)));
			music.setData(c.getString(c.getColumnIndexOrThrow(Media.DATA)));
			music.setDuration(c.getLong(c.getColumnIndexOrThrow(Media.DURATION)));
			music.setBookmark(c.getLong(c.getColumnIndexOrThrow(Media.BOOKMARK)));
			music.setComposer(c.getString(c
					.getColumnIndexOrThrow(Media.COMPOSER)));
			music.setAlbumId(c.getInt(c.getColumnIndexOrThrow(Media.ALBUM_ID)));
			music.setAlbum(c.getString(c.getColumnIndexOrThrow(Media.ALBUM)));
			music.setAlbumKey(c.getString(c
					.getColumnIndexOrThrow(Media.ALBUM_KEY)));
			music.setArtistId(c.getInt(c.getColumnIndexOrThrow(Media.ARTIST_ID)));
			music.setArtist(c.getString(c.getColumnIndexOrThrow(Media.ARTIST)));
			music.setArtistKey(c.getString(c
