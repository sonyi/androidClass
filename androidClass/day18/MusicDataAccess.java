package com.musicplayerdemo.data;
...
import com.musicplayerdemo.model.Music;
...
public class MusicDataAccess {
	...
	public List<Music> getAllMusic() {
		...
		String[] projection = new String[] { Media._ID,
				Media.TITLE, Media.TITLE_KEY,
				Media.DISPLAY_NAME, Media.TRACK,
				Media.YEAR, Media.DATA, Media.DURATION,
				Media.BOOKMARK, Media.COMPOSER,
				Media.ALBUM_ID, Media.ALBUM,
				Media.ALBUM_KEY, Media.ARTIST_ID,
		...
		while (cursor.moveToNext()) {
			...
			music.setId(cursor.getLong(cursor
	...
	public List<Music> getMusicByAlbumId(long albumId) {
		...
		String[] projection = new String[] { Media._ID,
				...
				Media.ALBUM_KEY, Media.ARTIST_ID,
				Media.ARTIST, Media.ARTIST_KEY };
		String selection = Media.IS_MUSIC + "=? and "
				+ Media.ALBUM_ID + "=?";
		String[] selectionArgs = new String[] { String.valueOf(1),
